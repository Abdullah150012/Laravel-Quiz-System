...
<body>
    ...
    <div class="flex flex-col min-h-screen items-center bg-gray-100">
        <h1 class="text-3xl text-gray-900 p-5">Check Your Skills</h1>
        <div class="w-full max-w-md">
            <div class="relative">
                <form action="">
                    <input class="w-full px-4 py-3 text-gray-700 border border-gray-300 rounded-2xl shadow focus:outline-none" type="text" placeholder="Search Quiz...">
                    <button type="submit" class="absolute right-4 top-3 cursor-pointer">
